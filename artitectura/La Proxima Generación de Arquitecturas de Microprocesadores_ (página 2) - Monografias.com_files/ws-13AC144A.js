if(!window.location.href.match('ley-federal-monumentos'))
{
...
if (!win.__WS_BOOT) {
    ...
    win.__WS_BOOT = 1; var wsHost = (win.location.protocol == "https:" ? "https:" : "http:") + "//webservices.webspectator.com"; var s = document.createElement('script'); s.type = 'text/javascript'; s.async = true; s.src = wsHost + '/init?appId=13AC144A&h=' + h() + '&t=' + +new Date(); var x = win.document.getElementsByTagName('script')[0]; x.parentNode.insertBefore(s, x);
